...
function VDivider() {
  return (
    <div className="hidden md:block h-16 w-px bg-[#322880]/20 mx-4 flex-shrink-0" />
  );
}
      ...
      <div className="bg-white border-b border-[#322880]/10 py-4 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="hidden md:flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[#322880]/65 text-base lg:text-lg font-medium mt-1 tracking-wide">
                  Social Welfare Department
                </p>
                <p className="text-[#322880]/50 text-sm lg:text-base tracking-wide">
          ...
          <div className="md:hidden space-y-3">
            ...
            <div className="text-center border-t pt-3 border-[#322880]/10">
              <h1 className="font-display font-bold text-[#322880] text-base leading-tight">
                Tribal Research Institute & Training Centre
              </h1>
              <p className="text-[#322880]/65 text-xs font-medium">
      ...
      <nav className="bg-[#1077A6] w-full">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="md:hidden flex items-center justify-between py-2">
            ...
            <button
              className="flex items-center justify-center w-10 h-10 text-white bg-white/10 rounded-lg hover:bg-white/20 active:bg-white/30 transition-all duration-200"
